        ...
        <>
            ...
            >
                ...
                <div className="relative z-10 max-w-5xl w-full mx-auto text-center">
                    ...
                    >
                        <Link to="https://github.com/Shivamsaini9795" target="_blank" rel="noopener noreferrer" className="hover:text-white">
                            <FaGithub />
                        </Link>
                        <Link to="https://www.linkedin.com/in/shivam-saini-517048310/" 
                        target="_blank" rel="noopener noreferrer" className="hover:text-white">
                            <FaLinkedin />
                        </Link>
                        <Link to="mailto:shivamsaini01364@gmail.com" className="hover:text-white">
                            <FaEnvelope />
                        </Link>
                    </motion.div>
                </div>
